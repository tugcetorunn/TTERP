...
namespace TTERP.Persistence.Migrations
{
    ...
    [Migration("20260714114902_addMaterialStockReservationEntity")]
    partial class addMaterialStockReservationEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.MaterialStockReservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductionId", "ProductionItemId");

                    b.HasIndex("MaterialId", "WarehouseId", "IsReleased");

                    b.ToTable("MaterialStockReservations");
                });
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.ProductionProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductionProgresses");
                });
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 7, 14, 11, 49, 1, 235, DateTimeKind.Utc).AddTicks(2352),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin",
                            NameForUI = "Admin",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 7, 14, 11, 49, 1, 235, DateTimeKind.Utc).AddTicks(2360),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Manager",
                            NameForUI = "Yönetici",
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 7, 14, 11, 49, 1, 235, DateTimeKind.Utc).AddTicks(2362),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User",
                            NameForUI = "Kullanıcı",
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = 0,
                            CreatedDate = new DateTime(2026, 7, 14, 11, 49, 1, 235, DateTimeKind.Utc).AddTicks(2363),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Auditor",
                            NameForUI = "Denetçi",
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.WorkflowHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.WorkflowTransition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("CreatesStockMovement")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("WorkflowType", "FromStatusCode", "ToStatusCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.MaterialStockReservation", b =>
                {
                    ...
                    b.HasOne("TTERP.Domain.Entities.Production", "Production")
                        .WithMany("MaterialStockReservations")
                        .HasForeignKey("ProductionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TTERP.Domain.Entities.ProductionItem", "ProductionItem")
                        .WithMany("MaterialStockReservations")
            ...
            modelBuilder.Entity("TTERP.Domain.Entities.Production", b =>
                {
                    ...
                    b.Navigation("ProductionProgresses");
                });
