...
{
    public class ProductionProgressRepository : BaseRepository<ProductionProgress>, IProductionProgressRepository
    {
        public ProductionProgressRepository(AppDbContext _context) : base(_context)
        {
        }
    }
}
